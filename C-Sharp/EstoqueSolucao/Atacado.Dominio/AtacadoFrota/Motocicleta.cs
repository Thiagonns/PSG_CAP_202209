...
namespace Atacado.Dominio.AtacadoFrota
{
    public class Motocicleta : BasePesoCarga
    {
        ...
        public Motocicleta(bool ativo, int codigo, DateTime dataInclusao, string chassi, string cor, string marca, string modelo, string placa, double pesoBruto, double pesoLiquido, double pesoTotal) 
