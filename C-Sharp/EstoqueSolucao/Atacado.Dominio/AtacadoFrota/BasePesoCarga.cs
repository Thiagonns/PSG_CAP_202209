...
namespace Atacado.Dominio.AtacadoFrota
{
    public abstract class BasePesoCarga : BaseVeiculo
    {
        ...
        protected BasePesoCarga()
        {
        }

        protected BasePesoCarga(bool ativo, int codigo, DateTime dataInclusao, string chassi, string cor, string marca, string modelo, string placa, double pesoBruto, double pesoLiquido, double pesoTotal) 
