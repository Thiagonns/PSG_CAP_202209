...
namespace TecnoShopApi.Controllers
{
    ...
    public class VendaItemController : ControllerBase
    {
        ...
        /// 
        /// </summary>
        public VendaItemServico servico;
        ...
        {
            this.servico = new VendaItemServico(context);
        }
        ...
        public ActionResult<List<VendaItemPoco>> GetAll(int? take = null, int? skip = null)
        {
            try
            {
                List<VendaItemPoco> listaPoco = this.servico.Listar(take, skip);
                return Ok(listaPoco);
            }
            catch (Exception ex)
            {
        ...
        public ActionResult<VendaItemPoco> GetById(int chave)
        {
            try
            {
                VendaItemPoco poco = this.servico.PesquisarPelaChave(chave);
                return Ok(poco);
            }
            catch (Exception ex)
            {
        ...
        public ActionResult<VendaItemPoco> Post([FromBody] VendaItemPoco poco)
        {
            try
            {
                VendaItemPoco novoPoco = this.servico.Inserir(poco);
                return Ok(novoPoco);
            }
            catch (Exception ex)
            {
        ...
        public ActionResult<VendaItemPoco> Put([FromBody] VendaItemPoco poco)
        {
            try
            {
                VendaItemPoco novoPoco = this.servico.Alterar(poco);
                return Ok(novoPoco);
            }
            catch (Exception ex)
            {
        ...
        public ActionResult<VendaItemPoco> DeleteById(int chave)
        {
            try
            {
                VendaItemPoco poco = this.servico.Excluir(chave);
                return Ok(poco);
            }
            catch (Exception ex)
            {
