...
namespace TecnoShopApi.Controllers
{
    ...
    public class EstoqueController : ControllerBase
    {
        ...
        public ActionResult<List<EstoquePoco>> GetAll(int? take = null, int? skip = null)
        {
            try
            {
                List<EstoquePoco> listaPoco = this.servico.Listar(take, skip);
                return Ok(listaPoco);
            }
            catch (Exception ex)
            {
        ...
        public ActionResult<EstoquePoco> GetById(int chave)
        {
            try
            {
                EstoquePoco poco = this.servico.PesquisarPelaChave(chave);
                return Ok(poco);
            }
            catch (Exception ex)
            {
        ...
        public ActionResult<EstoquePoco> Post([FromBody] EstoquePoco poco)
        {
            try
            {
                EstoquePoco novoPoco = this.servico.Inserir(poco);
                return Ok(novoPoco);
            }
            catch (Exception ex)
            {
        ...
        public ActionResult<EstoquePoco> Put([FromBody] EstoquePoco poco)
        {
            try
            {
                EstoquePoco novoPoco = this.servico.Alterar(poco);
                return Ok(novoPoco);
            }
            catch (Exception ex)
            {
        ...
        public ActionResult<EstoquePoco> DeleteById(int chave)
        {
            try
            {
                EstoquePoco poco = this.servico.Excluir(chave);
                return Ok(poco);
            }
            catch (Exception ex)
            {
