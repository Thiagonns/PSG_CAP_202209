...
namespace ExameCapApi.Controllers
{
    ...
    public class PassageiroController : ControllerBase
    {
        ...
        /// 
        /// </summary>
        public PassageiroServico servico;

        /// <summary>
        /// 
        /// </summary>
        /// <param name="context"></param>
        public PassageiroController(ExameContext context) : base()
        {
            this.servico = new PassageiroServico(context);
        }
        ...
        /// <returns></returns>
        [HttpGet("{chave:int}")]
        public ActionResult<PassageiroPoco> GetById(int chave)
        {
            try
            {
